          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="mb-8 text-gray-700">
                Whether you have questions about autism, want to volunteer, or need support finding resources,
              ...
              <div className="mt-8">
                <h3 className="font-bold text-xl mb-4 text-indigo-800">Follow Us</h3>
